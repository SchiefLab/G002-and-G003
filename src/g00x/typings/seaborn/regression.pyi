...
class _RegressionPlotter(_LinearPlotter):
    ...
    def bin_predictor(self, bins): # -> tuple[ndarray[Any, dtype[floating[Any]]] | ndarray[Any, dtype[Unknown]], NDArray[floating[Any]] | NDArray[Unknown]]:
...
_regression_docs = ...
def lmplot(data=..., *, x=..., y=..., hue=..., col=..., row=..., palette=..., col_wrap=..., height=..., aspect=..., markers=..., sharex=..., sharey=..., hue_order=..., col_order=..., row_order=..., legend=..., legend_out=..., x_estimator=..., x_bins=..., x_ci=..., scatter=..., fit_reg=..., ci=..., n_boot=..., units=..., seed=..., order=..., logistic=..., lowess=..., robust=..., logx=..., x_partial=..., y_partial=..., truncate=..., x_jitter=..., y_jitter=..., scatter_kws=..., line_kws=..., facet_kws=...): # -> FacetGrid:
    ...

def regplot(data=..., *, x=..., y=..., x_estimator=..., x_bins=..., x_ci=..., scatter=..., fit_reg=..., ci=..., n_boot=..., units=..., seed=..., order=..., logistic=..., lowess=..., robust=..., logx=..., x_partial=..., y_partial=..., truncate=..., dropna=..., x_jitter=..., y_jitter=..., label=..., color=..., marker=..., scatter_kws=..., line_kws=..., ax=...):
    ...

def residplot(data=..., *, x=..., y=..., x_partial=..., y_partial=..., lowess=..., order=..., robust=..., dropna=..., label=..., color=..., scatter_kws=..., line_kws=..., ax=...):
