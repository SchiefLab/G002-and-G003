...
_categorical_docs = ...
def boxplot(data=..., *, x=..., y=..., hue=..., order=..., hue_order=..., orient=..., color=..., palette=..., saturation=..., width=..., dodge=..., fliersize=..., linewidth=..., whis=..., ax=..., **kwargs):
    ...

def violinplot(data=..., *, x=..., y=..., hue=..., order=..., hue_order=..., bw=..., cut=..., scale=..., scale_hue=..., gridsize=..., width=..., inner=..., split=..., dodge=..., orient=..., linewidth=..., color=..., palette=..., saturation=..., ax=..., **kwargs):
    ...

def boxenplot(data=..., *, x=..., y=..., hue=..., order=..., hue_order=..., orient=..., color=..., palette=..., saturation=..., width=..., dodge=..., k_depth=..., linewidth=..., scale=..., outlier_prop=..., trust_alpha=..., showfliers=..., ax=..., box_kws=..., flier_kws=..., line_kws=...):
    ...

def stripplot(data=..., *, x=..., y=..., hue=..., order=..., hue_order=..., jitter=..., dodge=..., orient=..., color=..., palette=..., size=..., edgecolor=..., linewidth=..., hue_norm=..., native_scale=..., formatter=..., legend=..., ax=..., **kwargs):
    ...

def swarmplot(data=..., *, x=..., y=..., hue=..., order=..., hue_order=..., dodge=..., orient=..., color=..., palette=..., size=..., edgecolor=..., linewidth=..., hue_norm=..., native_scale=..., formatter=..., legend=..., warn_thresh=..., ax=..., **kwargs):
    ...

def barplot(data=..., *, x=..., y=..., hue=..., order=..., hue_order=..., estimator=..., errorbar=..., n_boot=..., units=..., seed=..., orient=..., color=..., palette=..., saturation=..., width=..., errcolor=..., errwidth=..., capsize=..., dodge=..., ci=..., ax=..., **kwargs):
    ...

def pointplot(data=..., *, x=..., y=..., hue=..., order=..., hue_order=..., estimator=..., errorbar=..., n_boot=..., units=..., seed=..., markers=..., linestyles=..., dodge=..., join=..., scale=..., orient=..., color=..., palette=..., errwidth=..., ci=..., capsize=..., label=..., ax=...):
    ...

def countplot(data=..., *, x=..., y=..., hue=..., order=..., hue_order=..., orient=..., color=..., palette=..., saturation=..., width=..., dodge=..., ax=..., **kwargs):
    ...

def catplot(data=..., *, x=..., y=..., hue=..., row=..., col=..., col_wrap=..., estimator=..., errorbar=..., n_boot=..., units=..., seed=..., order=..., hue_order=..., row_order=..., col_order=..., height=..., aspect=..., kind=..., native_scale=..., formatter=..., orient=..., color=..., palette=..., hue_norm=..., legend=..., legend_out=..., sharex=..., sharey=..., margin_titles=..., facet_kws=..., ci=..., **kwargs):
    ...
