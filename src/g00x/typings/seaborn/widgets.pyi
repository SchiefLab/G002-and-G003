...
def choose_colorbrewer_palette(data_type, as_cmap=...): # -> list[Unknown]:
...
def choose_dark_palette(input=..., as_cmap=...): # -> list[Unknown]:
...
def choose_light_palette(input=..., as_cmap=...): # -> list[Unknown]:
...
def choose_diverging_palette(as_cmap=...): # -> list[Unknown]:
...
def choose_cubehelix_palette(as_cmap=...): # -> list[Unknown]:
