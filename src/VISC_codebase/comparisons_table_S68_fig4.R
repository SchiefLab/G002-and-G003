...
# Figure 4 comparisons for eOD at week 8 versus eOD->eOD at week 16
# Fig. 4D comparison: eOD at week 8 vs eOD-eOD at week 16
# Fig. 4E comparison: eOD at week 8 vs eOD-eOD at week 16
...
# Comparison table
compt = data.frame( pgrp1=c(1),
                    pgrp2=c(3),
                    wk1 = c(8),
                    wk2 = c(16))

# For these comparisons we would expect to do a paired test but the
# Week 8 data are available only for eOD->core group2
# so the week 16 data for eOD->eOD at week 16 are independent (groups 1 and 3)
# therefore set paired = FALSE
compt$paired = FALSE
...
write.csv(stat, file.path(STATS, 'fig4eOD_pvals.csv'), row.names = FALSE)
